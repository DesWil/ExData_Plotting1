...
> 
> subDateTime <- strptime(paste(subdataFile$Date, subdataFile$Time,sep = " "), "%d/%m/%Y %H:%M:%S")
> 
> png("plot2.png", width=480, height=480)
> 
> plot(subDateTime, as.numeric(subdataFile$Global_active_power), type="l", xlab="", ylab="Global Active Power (kilowatts)")
> 
> 
